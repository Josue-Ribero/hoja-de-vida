<div align="center">
  ...
  <p>
  Este proyecto es una app desarrollada en FastAPI que responde con un HTML para la ruta principal.
  </p>

  [![Version](https://img.shields.io/badge/Version-1.0.0-blue.svg)](https://github.com/Josue-Ribero/hoja-de-vida/releases)
...
└── 📄 .gitignore                       # Dependencias que no se suben al repositorio
```
...
1.  **Clonar el repositorio:**
    ...
    ```bash
    git clone https://github.com/Josue-Ribero/hoja-de-vida.git
    ```
...
4.  **Instalar dependencias** (El `requirements.txt` contiene `fastapi`, `uvicorn`, etc.).
    El comando que debes ejecutar es:
    ```bash
